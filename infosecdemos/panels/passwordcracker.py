...
class PasswordCrackerPanel(wx.Panel):
    def __init__(self, parent):
        ...
        grid_sizer_1.Add(self.passwd_entry, 0,
                         wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add(self.save_passwd_btn, 0,
                         wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add(self.label_2, 0,
                         wx.ALIGN_RIGHT|wx.ALIGN_CENTER_VERTICAL, 0)
        grid_sizer_1.Add(self.hash_entry, 0,
                         wx.EXPAND|wx.ALIGN_CENTER_VERTICAL, 0)
    ...
    def password_save(self, event):
        ...
        hashname_index = self.hash_select.GetCurrentSelection()
        hashname = self.hash_select.GetItems()[hashname_index]
